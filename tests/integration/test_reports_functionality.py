...
from src.providers.storage import MemoryStorage, FileStorage, DatabaseStorage
...
class TestReportSavingLogic:
    ...
    async def test_crossref_analysis_saves_report_by_default(self, mock_security_analysis_usecase):
    ...
    async def test_crossref_analysis_skips_report_when_disabled(self, mock_security_analysis_usecase):
    ...
    async def test_crossref_analysis_handles_storage_failure(self, mock_security_analysis_usecase):
...
class TestDefaultStorageConfiguration:
    ...
    def test_memory_storage_factory_creation(self):
        ...
        config_dict = {
            ...
            "logging": {"level": "INFO", "format": "test", "file_path": None, "max_file_size_mb": 10, "backup_count": 5}
        }
