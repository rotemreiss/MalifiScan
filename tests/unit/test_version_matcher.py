...
class TestVersionMatcher:
    ...
    def test_is_critical_match_with_overlap(self):
        ...
        assert (
            VersionMatcher.is_critical_match(registry_versions, malicious_versions)
            is True
        )
    ...
    def test_get_matching_versions(self):
        ...
        actual = VersionMatcher.get_matching_versions(
    ...
    def test_get_matching_versions_no_overlap(self):
        ...
        assert (
            VersionMatcher.get_matching_versions(registry_versions, malicious_versions)
            == []
        )
    ...
    def test_complex_version_overlap_scenario(self):
        ...
        actual_matches = VersionMatcher.get_matching_versions(
            registry_versions, malicious_versions
        )
