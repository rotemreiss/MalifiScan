...
class TestNullRegistry:
    ...
    def test_null_registry_initialization_with_simulation(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_check_existing_packages_disabled(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_check_existing_packages_with_simulation(self, sample_malicious_package, sample_npm_malicious_package):
        ...
        assert existing[0].name == "test-pypi-pkg"  # sample_malicious_package is the PyPI package
    ...
    async def test_check_existing_packages_case_insensitive(self):
        ...
        lookup_packages = [MaliciousPackage(
    ...
    @pytest.mark.asyncio
    async def test_search_packages_with_simulation(self, sample_malicious_package, sample_npm_malicious_package):
        ...
        assert results[0]["versions"] == ["1.0.0", "1.1.0"]  # From sample_npm_malicious_package affected_versions
    ...
    @pytest.mark.asyncio
    async def test_block_operations_disabled(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_ecosystem_filtering(self, sample_malicious_package, sample_npm_malicious_package):
