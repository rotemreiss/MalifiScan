...
class TestMemoryStorageScanResults:
    ...
    @pytest.mark.asyncio
    @pytest.mark.asyncio
    async def test_store_scan_result_duplicate_replaces(
        self, memory_storage, sample_scan_result
    ):
...
class TestMemoryStorageMaliciousPackages:
    ...
    async def test_store_malicious_packages_success(
        self, memory_storage, sample_malicious_package
    ):
        """Test successful malicious package storage."""
        result = await memory_storage.store_malicious_packages(
            [sample_malicious_package]
        )
        assert result is True

    @pytest.mark.asyncio
    async def test_store_malicious_packages_avoid_duplicates(
        self, memory_storage, sample_malicious_package
    ):
...
class TestMemoryStorageUtilities:
    ...
    async def test_clear_all_data(
        self, memory_storage, sample_scan_result, sample_malicious_package
    ):
