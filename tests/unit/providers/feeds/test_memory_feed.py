...
class TestMemoryFeed:
    ...
    def test_memory_feed_initialization_with_packages(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_get_available_ecosystems(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_packages(self, sample_malicious_package, sample_npm_malicious_package):
        ...
        assert result[1].name == "test-critical-npm"   # From sample_npm_malicious_package
    
    @pytest.mark.asyncio
    async def test_fetch_packages_by_ecosystem(self, sample_malicious_package, sample_npm_malicious_package):
        ...
        assert npm_packages[0].name == "test-critical-npm"  # Updated to match consolidated fixture
        ...
        assert pypi_packages[0].name == "test-pypi-pkg"  # Updated to match consolidated fixture
    ...
    @pytest.mark.asyncio
    async def test_fetch_packages_with_limit(self, sample_malicious_package, sample_npm_malicious_package):
    ...
    @pytest.mark.asyncio
    async def test_ecosystem_filtering_case_insensitive(self, sample_malicious_package, sample_npm_malicious_package):
