...
class TestOSVFeedMultiEcosystem:
    ...
    async def test_get_available_ecosystems_success(self, osv_feed):
        ...
        with patch.object(osv_feed, '_get_malicious_package_ids', side_effect=mock_get_malicious_package_ids):
    ...
    async def test_get_available_ecosystems_error(self, osv_feed):
        ...
        with patch.object(osv_feed, '_get_malicious_package_ids', side_effect=Exception("Storage error")):
            ecosystems = await osv_feed.get_available_ecosystems()
    ...
    async def test_fetch_malicious_packages_all_ecosystems(self, osv_feed):
        ...
        with patch.object(osv_feed, 'get_available_ecosystems', return_value=["npm", "PyPI"]) as mock_get_ecosystems:
            with patch.object(osv_feed, '_fetch_malicious_packages_for_ecosystem') as mock_fetch_ecosystem:
                ...
                packages = await osv_feed.fetch_malicious_packages(max_packages=100, hours=24)
    ...
    async def test_fetch_malicious_packages_specific_ecosystems(self, osv_feed):
        ...
        with patch.object(osv_feed, '_fetch_malicious_packages_for_ecosystem', return_value=[mock_package]) as mock_fetch:
    ...
    async def test_fetch_malicious_packages_ecosystem_failure(self, osv_feed):
        ...
        with patch.object(osv_feed, 'get_available_ecosystems', return_value=["npm", "PyPI"]):
            with patch.object(osv_feed, '_fetch_malicious_packages_for_ecosystem') as mock_fetch:
                def mock_fetch_side_effect(ecosystem, max_packages, hours):
                    if ecosystem == "npm":
    ...
    async def test_fetch_malicious_packages_no_packages_found(self, osv_feed):
        ...
        with patch.object(osv_feed, 'get_available_ecosystems', return_value=["npm", "PyPI"]):
            with patch.object(osv_feed, '_fetch_malicious_packages_for_ecosystem', return_value=[]):
                packages = await osv_feed.fetch_malicious_packages(max_packages=100, hours=24)
    ...
    async def test_backward_compatibility_single_ecosystem(self, osv_feed):
        ...
        with patch.object(osv_feed, 'get_available_ecosystems', return_value=["npm"]):
            with patch.object(osv_feed, '_fetch_malicious_packages_for_ecosystem', return_value=[mock_package]) as mock_fetch:
                ...
                packages = await osv_feed.fetch_malicious_packages(max_packages=50, hours=12)
