...
class TestWebhookNotifier:
    ...
    def test_init_with_invalid_scheme_raises_error(self):
        ...
        with pytest.raises(NotificationError, match="Webhook URL must use HTTP or HTTPS"):
    ...
    @pytest.mark.asyncio
    async def test_send_notification_with_affected_packages(self, critical_notification_event):
    ...
    @pytest.mark.asyncio
    async def test_send_notification_failure_with_retries(self, basic_notification_event):
    ...
    @pytest.mark.asyncio
    async def test_send_notification_permanent_error_no_retry(self, basic_notification_event):
    ...
    def test_create_standard_payload(self, critical_notification_event, sample_npm_malicious_package):
    ...
    def test_custom_headers_included(self):
        ...
        notifier = WebhookNotifier(webhook_url=webhook_url, custom_headers=custom_headers)
