...
class TestPackagesFeedInterface:
    ...
    @pytest.mark.asyncio
    async def test_fetch_malicious_packages_with_max_limit(self, mock_feed, sample_packages):
    ...
    @pytest.mark.asyncio
    async def test_fetch_malicious_packages_with_hours_parameter(self, mock_feed, sample_packages):
