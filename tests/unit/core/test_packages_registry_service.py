...
class MockPackagesRegistryService(PackagesRegistryService):
    ...
    async def check_existing_packages(
        ...
        for package in packages:
            if (
                package in self.existing_packages
                or package.package_identifier in self.blocked_packages
            ):
...
class TestPackagesRegistryServiceInterface:
    ...
    @pytest.mark.asyncio
    async def test_check_existing_packages_none_exist(
        self, mock_registry, sample_packages
    ):
    ...
    @pytest.mark.asyncio
    async def test_check_existing_packages_some_exist(
        self, mock_registry, sample_packages
    ):
    ...
    @pytest.mark.asyncio
    async def test_check_existing_packages_blocked_packages(
        self, mock_registry, sample_packages
    ):
