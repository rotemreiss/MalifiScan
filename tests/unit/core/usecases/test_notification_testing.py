...
class TestNotificationTestingUseCase:
    """Test suite for NotificationTestingUseCase."""
    ...
    @pytest.mark.asyncio
    async def test_basic_notification_test_success(self, notification_testing_usecase, mock_notification_service):
        """Test successful basic notification test."""
        result = await notification_testing_usecase.test_notification_service(include_malicious=False)
    ...
    @pytest.mark.asyncio
    async def test_malicious_package_notification_test_success(self, notification_testing_usecase, mock_notification_service):
        """Test successful malicious package notification test."""
        result = await notification_testing_usecase.test_notification_service(include_malicious=True)
    ...
    @pytest.mark.asyncio
    async def test_health_check_failure(self, notification_testing_usecase, mock_notification_service):
    ...
    @pytest.mark.asyncio
    async def test_health_check_exception(self, notification_testing_usecase, mock_notification_service):
    ...
    @pytest.mark.asyncio
    async def test_notification_send_failure(self, notification_testing_usecase, mock_notification_service):
    ...
    @pytest.mark.asyncio
    async def test_notification_send_exception(self, notification_testing_usecase, mock_notification_service):
    ...
    @pytest.mark.asyncio
    async def test_both_test_types_use_different_event_structures(self, notification_testing_usecase, mock_notification_service):
        """Test that basic and malicious tests create different event structures."""
        # Test basic notification
        basic_result = await notification_testing_usecase.test_notification_service(include_malicious=False)
        ...
        malicious_result = await notification_testing_usecase.test_notification_service(include_malicious=True)
