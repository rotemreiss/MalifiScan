...
class TestStorageServiceInterface:
    ...
    async def test_store_scan_result_success(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_store_scan_result_failure(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_store_multiple_scan_results(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_scan_results_all(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_scan_results_by_scan_id(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_scan_results_nonexistent_scan_id(
        self, mock_storage_service, sample_scan_results
    ):
    ...
    @pytest.mark.asyncio
    async def test_store_malicious_packages_success(
        self, mock_storage_service, sample_malicious_packages
    ):
        """Test successful malicious packages storage."""
        result = await mock_storage_service.store_malicious_packages(
        ...
        assert (
            mock_storage_service.stored_malicious_packages == sample_malicious_packages
        )

    @pytest.mark.asyncio
    async def test_store_malicious_packages_duplicates(
        self, mock_storage_service, sample_malicious_packages
    ):
    ...
    @pytest.mark.asyncio
    async def test_store_malicious_packages_failure(
        self, mock_storage_service, sample_malicious_packages
    ):
    ...
    @pytest.mark.asyncio
    async def test_store_malicious_packages_error(
        self, mock_storage_service, sample_malicious_packages
    ):
        ...
        with pytest.raises(Exception, match="Package storage failed"):
            await mock_storage_service.store_malicious_packages(
                sample_malicious_packages
            )
    ...
    @pytest.mark.asyncio
    async def test_get_known_malicious_packages(
        self, mock_storage_service, sample_malicious_packages
    ):
    ...
    @pytest.mark.asyncio
    async def test_interface_contract_compliance(
        self, mock_storage_service, sample_scan_results, sample_malicious_packages
    ):
        ...
        store_result = await mock_storage_service.store_scan_result(
            sample_scan_results[0]
        )
        ...
        store_packages_result = await mock_storage_service.store_malicious_packages(
            sample_malicious_packages
        )
    ...
    def test_interface_is_abstract(self):
        ...
        with pytest.raises(
            TypeError, match="Can't instantiate abstract class StorageService"
        ):
    ...
    async def test_full_storage_lifecycle(
        ...
        specific_result = await mock_storage_service.get_scan_results(
            scan_id="scan-002"
        )
