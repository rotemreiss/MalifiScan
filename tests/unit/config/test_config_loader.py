...
def test_config_loader_init_defaults():
...
def test_load_with_invalid_yaml():
...
def test_load_with_yaml_error_specific():
...
def test_load_with_file_read_error():
...
def test_load_empty_yaml_file():
    ...
    def test_override_with_env_nested_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.dict(
                os.environ, {"LOG_LEVEL": "DEBUG", "LOG_FILE_PATH": "/var/log/app.log"}
            ):
                loader = ConfigLoader(
                    str(config_file),
                    local_config_file=None,
    ...
    def test_convert_env_value_invalid_integer(self):
        ...
        assert (
            loader._convert_env_value("not_a_number", "email_smtp_port")
            == "not_a_number"
        )
    ...
    def test_convert_env_value_list(self):
        ...
        result = loader._convert_env_value(
            "email1@example.com,email2@example.com", "email_to_addresses"
        )
    ...
    def test_convert_env_value_string(self):
        ...
        assert (
            loader._convert_env_value("https://api.example.com", "api_url")
    ...
    def test_validate_config_jfrog_enabled_missing_credentials(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(
                ConfigError, match="JFrog API key or username/password is required"
            ):
                loader.load()
    ...
    def test_generic_exception_during_load(self):
        ...
        with patch.object(
            ...
            with pytest.raises(
                ConfigError, match="Failed to load configuration: Generic error"
            ):
                loader.load()
...
class TestConfigModels:
    ...
    def test_provider_config_custom_values(self):
        ...
        config = ProviderConfig(type="custom", enabled=False, config={"key": "value"})
