...
class PackageManagementUseCase:
    ...
    async def search_package(self, package_name: str, ecosystem: str = "npm") -> Dict[str, Any]:
        ...
        """
        try:
            self.logger.info(f"Searching for package: {package_name} ({ecosystem})")
            ...
            self.logger.info(f"Package search completed: {len(search_results)} results found, blocked: {is_blocked}")
            return result
    ...
    async def block_package(self, package_name: str, ecosystem: str = "npm", version: str = "*") -> Dict[str, Any]:
        ...
        """
        try:
            self.logger.info(f"Blocking package: {package_name} ({ecosystem}) version {version}")
            ...
            if success:
                self.logger.info(f"Successfully blocked {package_name}")
