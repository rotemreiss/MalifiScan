...
class FileStorage(StorageService):
    ...
    async def store_scan_result(self, scan_result: ScanResult) -> bool:
        ...
        try:
            ...
            logger.debug(f"Successfully stored scan result: {scan_result.scan_id} to {file_path}")
            return True
            ...
            if scan_id:
                ...
                for file_path in json_files:
                    try:
                        ...
                        logger.warning(f"Failed to parse scan result file {file_path}: {e}")
                        continue
    ...
    def _dict_to_scan_result(self, data: Dict[str, Any]) -> ScanResult:
        ...
        malicious_list_key = 'malicious_packages_list' if 'malicious_packages_list' in data else 'packages_already_present'
    ...
    def _malicious_package_to_dict(self, package: MaliciousPackage) -> Dict[str, Any]:
        ...
        return {
            ...
            'modified_at': package.modified_at.isoformat() if package.modified_at else None
        }
        
    def _simplified_malicious_package_to_dict(self, package: MaliciousPackage) -> Dict[str, Any]:
